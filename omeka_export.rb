	...
	def create_sound_items_csv(sound_items, name)
		...
		if !memorial_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_description", "it_institution", "it_type", "it_dedication_date", "it_historical_date", "it_url", "it_aspects", "it_themes", "group_represented", "location", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_moving_image_items_csv(moving_image_items, name)
  		if !moving_image_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_transcription", "it_original_format", "it_duration", "it_compression", "it_producer", "it_director", "it_player", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_oral_history_items_csv(oral_history_items, name)
  		if !oral_history_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_interviewer", "it_interviewee", "it_location", "it_transcription", "it_original_format", "it_duration", "it_bitrate", "it_time_summary", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_text_items_csv(text_items, name)
  		if !text_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_text", "it_original_format", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_event_items_csv(event_items, name)
  		if !event_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_duration", "it_event_type", "it_participants", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_website_items_csv(website_items, name)
  		if !website_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_local_url", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_hyperlink_items_csv(hyperlink_items, name)
  		if !hyperlink_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_url", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
  	...
  	def create_image_items_csv(image_items, name)
  		if !image_items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "it_original_format", "it_physical_dimensions", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
				 image_items.each do |item|
	    			csv << [item.id, title_nil_check(item.element_texts[0]), item.public, item.featured, md_nil_check(item.element_texts[1], "Dublin Core:Subject"), md_nil_check(item.element_texts[2], "Dublin Core:Description"), md_nil_check(item.element_texts[3], "Dublin Core:Creator"), md_nil_check(item.element_texts[4], "Dublin Core:Source"), md_nil_check(item.element_texts[5], "Dublin Core:Publisher"), md_nil_check(item.element_texts[6], "Dublin Core:Date"),md_nil_check(item.element_texts[7], "Dublin Core:Contributor"), md_nil_check(item.element_texts[8], "Dublin Core:Rights"), md_nil_check(item.element_texts[9], "Dublin Core:Relation"), md_nil_check(item.element_texts[10], "Dublin Core:Format"), md_nil_check(item.element_texts[11], "Dublin Core:Language"), md_nil_check(item.element_texts[12], "Dublin Core:Type"), md_nil_check(item.element_texts[13], "Dublin Core:Identifier"), md_nil_check(item.element_texts[14], "Dublin Core:Coverage"), md_nil_check(item.element_texts[15], "Item Type Metadata:Original Format"), md_nil_check(item.element_texts[16], "Item Type Metadata:Physical Dimensions"),collection_nil_check(item.collection), item_type_nil_check(item.item_type), url_nil_check(item.files), collect_tags(item.tags)]
	    		end
	  		end
	  	end
  	end
  	...
  	def create_items_csv(items, name)
  		if !items.empty?
			...
			CSV.open(csv_file, 'ab') do |csv|
				file = CSV.read(csv_file,:encoding => "iso-8859-1",:col_sep => ",")
			  	if file.none?
			    	csv << ["id", "title", "public", "featured", "dc_subject", "dc_desc", "dc_creator", "dc_source", "dc_publisher", "dc_date", "dc_contributor","dc_rights", "dc_relation", "dc_format", "dc_language", "dc_type", "dc_identifier", "dc_coverage", "collection_reference", "itemtype_reference", "file_url", "tags"]
			  	end
				 items.each do |item|
	    			csv << [item.id, title_nil_check(item.element_texts[0]), item.public, item.featured, md_nil_check(item.element_texts[1], "Dublin Core:Subject"), md_nil_check(item.element_texts[2], "Dublin Core:Description"), md_nil_check(item.element_texts[3], "Dublin Core:Creator"), md_nil_check(item.element_texts[4], "Dublin Core:Source"), md_nil_check(item.element_texts[5], "Dublin Core:Publisher"), md_nil_check(item.element_texts[6], "Dublin Core:Date"),md_nil_check(item.element_texts[7], "Dublin Core:Contributor"), md_nil_check(item.element_texts[8], "Dublin Core:Rights"), md_nil_check(item.element_texts[9], "Dublin Core:Relation"), md_nil_check(item.element_texts[10], "Dublin Core:Format"), md_nil_check(item.element_texts[11], "Dublin Core:Language"), md_nil_check(item.element_texts[12], "Dublin Core:Type"), md_nil_check(item.element_texts[13], "Dublin Core:Identifier"), md_nil_check(item.element_texts[14], "Dublin Core:Coverage"),collection_nil_check(item.collection), item_type_nil_check(item.item_type), url_nil_check(item.files), collect_tags(item.tags)]
	    		end
	  		end
	  	end
  	end
